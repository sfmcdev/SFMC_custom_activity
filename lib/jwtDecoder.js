...
JwtDecoder.prototype.decode = function( req ) {
    ...
    try {
        ...
        console.log( 'Decoding failed for jwt appSig: ', jwt );
    }
	...
	try {
        ...
        console.log( 'Decoding failed for jwt appId: ', jwt );
    }
	...
	try {
        ...
        console.log( 'Decoding failed for jwt clientSecret: ', jwt );
	...
	try {
        ...
        console.log( 'Decoding failed for jwt clientId: ', jwt );        
    }
