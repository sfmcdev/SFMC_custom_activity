...
jwt.decode = function jwt_decode(token, key, noVerify) {	
	...
	console.log( 'jwt.decode|key:', key);
	console.log( 'jwt.decode|noverify:', noVerify);
  // check seguments
  ...
  if (!noVerify) {
	...
	var signResult = sign(signingInput, key, signingMethod);
	console.log( 'jwt.decode|signResult:', signResult);	
	console.log( 'jwt.decode|signatureSeg:', signatureSeg);
	//console.log( 'jwt.decode|payloadSeg:', payload);
	
	//console.log( 'jwt.decode != ', (signatureSeg != signResult));
	//console.log( 'jwt.decode !== ', (signatureSeg !== signResult));
	
    if (signatureSeg != signResult) 
	{
